...
const ItemWrapper = styled.div`
  ...
  &[data-active='true'] {
    background: ${props => props.theme.colors.platformMedium};
    &:hover {
      background: ${props => props.theme.colors.platformMedium};
    }
  }
...
function Item ({ token, onClick, isSymbolOnly, isActive }) {
  return (
    <ItemWrapper onClick={onClick} data-active={isActive}>
      <TokenDisplay
        token={{
          ...token,
          symbol: isSymbolOnly
